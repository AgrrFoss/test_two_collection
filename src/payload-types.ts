...
export interface Config {
  ...
  collectionsSelect: {
    ...
    servicesSub: ServicesSubSelect<false> | ServicesSubSelect<true>;
...
/**
 * Подписки закреленные за услугами
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "servicesSub".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'servicesSub';
        value: number | ServicesSub;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "servicesSub_select".
 */
